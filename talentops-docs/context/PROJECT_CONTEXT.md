...
**Consent/recording:** every Vexa call (both contexts, sandbox included) requires consent announced at call start; self-hosted recording = compliance fully in-house. Demographics for the Bias Lens: optional, self-reported, segregated, aggregate-only (GDPR Art. 9 class — D15).
