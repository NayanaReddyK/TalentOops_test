...
| **Vexa** | Self-hosted, open-source Google Meet bot handling all meeting joins + WebRTC audio bridging for both voice contexts (D17/D18); relays audio between Google Meet and the Gemini Live API WebRTC session; replaces Recall.ai. |
